        ...
        currentUser.yuvakId !== post._id ?(
            landLord && (
                <div className='flex flex-col gap-2' >
                    ...
                    <textarea className='w-full text-black border p-3 rounded-lg' name="message" id="message" rows="2" value={message} onChange={onhandleChange} placeholder='Enter your message Here' ></textarea>
